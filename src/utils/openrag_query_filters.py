...
Uses `.keyword` subfields for exact term/terms matching, consistent with
SearchService and the documents index mapping.
"""
...
# Frontend filter keys -> OpenSearch keyword field names (exact match)
